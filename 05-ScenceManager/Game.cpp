...
void CGame::Init(HWND hWnd)
{
	...
	Camera::getInstance()->setSize(250, 190);
...
*/
void CGame::Draw(float x, float y , int anchorX, int anchorY, LPDIRECT3DTEXTURE9 texture, float left, float top, float right, float bottom, int alpha)
{
...
void CGame::DrawRect(float x, float y, int anchorX, int anchorY, LPDIRECT3DTEXTURE9 texture, RECT rect, int alpha)
{
	spriteHandler->Draw(texture, &rect, &D3DXVECTOR3(anchorX, anchorY, 0), &D3DXVECTOR3(x, y, 0), D3DCOLOR_ARGB(alpha, 255, 255, 255));
}
