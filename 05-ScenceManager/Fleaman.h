...
#define FLEAMAN_VY_SHORT 0.025
#define FLEAMAN_VY_LONG 0.15
#define FLEAMAN_VY_WHEN_JUMB 0.0025
#define FLEAMAN_VX_WHEN_JUM 1
#define FLEAMAN_VX 0.02
#define FLEAMAN_GRAVITY -0.002
#define FLEAMAN_JUMBLONG_COUNTER 1
#define FLEAMAN_FUMBSHORT_COUNTER 3
